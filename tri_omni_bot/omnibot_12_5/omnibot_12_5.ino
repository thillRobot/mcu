...
void set_velocity(float vel_x, float vel_y, float omega){
  ...
  Serial.println(map_double(w1, -1000, 1000, 0, 179), 4);
  
  // scale it to use it with the servo (value between 0 and 180) 
  // set the servo velocity according to the scaled value
  servo1.write(map_double(w1, -5000, 5000, 0, 179));                   
  servo2.write(map_double(w2, -5000, 5000, 0, 179));                   
  servo3.write(map_double(w3, -5000, 5000, 0, 179));                  
}
// controller Scheme A
  /*
