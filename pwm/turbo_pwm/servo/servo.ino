//this code  comes from the link below
//https://github.com/ocrdu/Arduino_SAMD21_turbo_PWM/blob/master/examples/servo/servo.ino
...
void setup() {
  ...
  servo.timer(2, 1, 960000, true);  // Timer 1 is set to Generic Clock divided by 1, resolution is 960000, left-aligned aka single-slope PWM
  servo.enable(2,true);
