...
volatile int16_t counts=0,ref_cps=-1800, cps=0, prev_cps=0, diff_cps=0; // reference counts per second
...
ISR(TIMER1_OVF_vect) {
    ...
    ctrl_cmd=(ref_cps-cps)*.1+(prev_cps-cps)*.01;
